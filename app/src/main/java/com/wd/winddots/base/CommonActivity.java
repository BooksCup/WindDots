...
public abstract class CommonActivity<V, T extends BasePresenter<V>> extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        mRightIcon = findViewById(R.id.activity_common_right_icon);
        mRightText = findViewById(R.id.activity_common_right_text);
