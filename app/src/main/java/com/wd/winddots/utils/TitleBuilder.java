...
//        rightIco = (ImageView)titleView.findViewById(R.id.title_rightIco);
    ...
    /**
     * 使用方法 - onCreate()
     *  new TitleBuilder(this).setTitleText(PhoneName).setLeftIco(R.drawable.menu_left)
     *  .setRightIco(R.drawable.icon_option).setLeftIcoListening(onClickListener)
     *  .setRightIcoListening(onClickListener);
     */
}
