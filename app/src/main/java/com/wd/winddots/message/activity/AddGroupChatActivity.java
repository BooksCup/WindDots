...
/**
 * FileName: AddGroupChatActivity
 * Author: 郑
 * Date: 2020/8/26 10:28 AM
 * Description: 添加群聊页面
 */
public class AddGroupChatActivity extends CommonActivity implements AddGroupChatAdapter.OnSubItemClickListener {
    ...
    private AddGroupChatActivity.HeaderAdapter mHeaderAdapter;
    ...
    public void initView() {
        ...
        addBadyView(R.layout.activity_add_group_chat);
    ...
    private void saveBtnDidClick() {
        ...
        groupName = "群聊";
        showLoading();
        compositeSubscription.add(dataManager.addGroupChat(owner, groupName, userIds, "").
                subscribeOn(Schedulers.io()).
                observeOn(AndroidSchedulers.mainThread()).
                subscribe(new Observer<String>() {
                    @Override
                    ...
                    public void onError(Throwable e) {
                        hideLoading();
                        Log.e("net666", String.valueOf(e));
                        showToast(mContext.getString(R.string.add_group_chat_error));
                    }
                    ...
                    public void onNext(String s) {
                        ...
                        if (bean == null || StringUtils.isNullOrEmpty(bean.getId())) {
                            showToast(mContext.getString(R.string.add_group_chat_error));
                            return;
                        }
                        ...
                        setResult(0, intent);
                        EventBus.getDefault().postSticky("updateGroupList");
                        finish();
                    }
                })
        );
