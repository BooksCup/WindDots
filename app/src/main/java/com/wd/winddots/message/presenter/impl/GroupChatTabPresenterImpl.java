...
import com.wd.winddots.message.presenter.GroupChatTabPresenter;
...
//                            }.getType());
    ...
    @Override
    public void outGroupPerson(String userId, String groupId) {
        compositeSubscription.add(dataManager.outGroupPerson(userId, groupId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<String>() {
                    @Override
                    ...
                    @Override
                    public void onError(Throwable e) {
                        Log.e("net666outGroupPerson", String.valueOf(e));
                    }

                    @Override
                    public void onNext(String data) {
                        Log.e("net666outGroupPerson",data);
                    }
                }));
    }
}
