 ...
 * Description:
 */
public class ContractDetailTapAdapter extends FragmentPagerAdapter {

    private String[] homeTitles = new String[]{"合同明细", "附加条款"};
    ...
    public ContractDetailTapAdapter(FragmentManager fm, String orderId) {
        super(fm);
        mOrderId = orderId;
    }
