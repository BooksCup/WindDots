 ...
 * Description: 人员列表
 */
public class EmployeeListActivity extends CommonActivity
    ...
    public void initView() {
        ...
        mAdapter = new EmployeeListAdapter(R.layout.item_employee_list,dataSource);
        ...
        if (1 == SpHelper.getInstance(mContext).getInt("userIsSuperAdmin")){
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(mContext, EmployeeApplyActivity.class);
