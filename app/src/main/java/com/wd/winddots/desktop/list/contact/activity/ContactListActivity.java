...
import com.wd.winddots.desktop.list.contact.adapter.ContractListAdapter;
...
public class ContactListActivity extends BaseActivity
    ...
    private List<ContractListBean.ContractListItem> mDataSource = new ArrayList<>();
    ...
    public void initView() {
        ...
        mFilterView.setTitle(mContext.getString(R.string.contract_filter));
        ...
        mAdapter = new ContractListAdapter(R.layout.item_contract_list, mDataSource);
...
//        data.put("exchangeGroupFlag", 0);
        ...
        compositeSubscription.add(dataManager.getContractList(requestBody,enterpriseId).
                ...
                subscribe(new Observer<String>() {
                    ...
                    public void onNext(String s) {
                        ...
                        Log.e("net666", s);
                        Gson gson = new Gson();
                        ContractListBean bean = gson.fromJson(s, ContractListBean.class);
                        List<ContractListBean.ContractListItem> list = bean.getList();
                        if (list == null){
                            list = new ArrayList<>();
                        }
...
//                        }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        ContractListBean.ContractListItem item = mDataSource.get(position);
        Gson gson = new Gson();
