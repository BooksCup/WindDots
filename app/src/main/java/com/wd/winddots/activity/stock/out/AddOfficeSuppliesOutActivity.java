 ...
 * @author zhou
 */
public class AddOfficeSuppliesOutActivity extends BaseActivity implements StockApplyGoodsSpecAdapter.TextChangeListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_goods:
                ...
                if (TextUtils.isEmpty(mGoodsId)) {
                    // 未选择物品
                    intent = new Intent(AddOfficeSuppliesOutActivity.this, SelectGoodsActivity.class);
            ...
            case R.id.ll_auditor:
                // 审核人
                intent = new Intent(AddOfficeSuppliesOutActivity.this, SelectSingleUserActivity.class);
            ...
            case R.id.iv_delete_goods:
                ...
                mConfirmDialog.setOnDialogClickListener(new ConfirmDialog.OnDialogClickListener() {
                    ...
                    public void onOkClick() {
                        ...
                        mGoodsNameTv.setTextColor(ContextCompat.getColor(AddOfficeSuppliesOutActivity.this, R.color.colorB2));
    ...
    private void startScanActivity() {
        Intent intent = new Intent(AddOfficeSuppliesOutActivity.this, CaptureActivity2.class);
    ...
    private void initListener() {
        mImagePickerAdapter.setOnRecyclerItemClickListener(position -> {
            ...
            if (position == imageEntityList.size() - 1) {
                try {
                    EasyPhotos.createAlbum(AddOfficeSuppliesOutActivity.this, true, GlideEngine.getInstance())
    ...
    private void addStockOutApply(String applyStatus) {
        ...
        mVolleyUtil.httpPostRequest(url, paramMap, response -> {
            ...
            hideLoadingDialog();
            mVolleyUtil.handleCommonErrorResponse(AddOfficeSuppliesOutActivity.this, volleyError);
        });
    }
