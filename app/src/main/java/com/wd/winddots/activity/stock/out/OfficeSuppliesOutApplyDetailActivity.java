 ...
 * @author zhou
 */
public class OfficeSuppliesOutApplyDetailActivity extends BaseActivity implements StockApplyGoodsSpecAdapter.TextChangeListener {
    ...
    String mStockOutApplyId;
    boolean mIsSkuEditable = true;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_office_supplies_out_apply);
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_goods:
                ...
                if (TextUtils.isEmpty(mGoodsId)) {
                    // 未选择物品
                    intent = new Intent(OfficeSuppliesOutApplyDetailActivity.this, SelectGoodsActivity.class);
            ...
            case R.id.ll_auditor:
                // 审核人
                intent = new Intent(OfficeSuppliesOutApplyDetailActivity.this, SelectSingleUserActivity.class);
            ...
            case R.id.iv_delete_goods:
                ...
                mConfirmDialog.setOnDialogClickListener(new ConfirmDialog.OnDialogClickListener() {
                    ...
                    public void onOkClick() {
                        ...
                        mGoodsNameTv.setTextColor(ContextCompat.getColor(OfficeSuppliesOutApplyDetailActivity.this, R.color.colorB2));
    ...
    private void startScanActivity() {
        Intent intent = new Intent(OfficeSuppliesOutApplyDetailActivity.this, CaptureActivity2.class);
    ...
    private void initView() {
        ...
        getStockInApplyById(mStockOutApplyId);
    }
    ...
    private void initListener() {
        mImagePickerAdapter.setOnRecyclerItemClickListener(position -> {
            ...
            if (position == imageEntityList.size() - 1) {
                try {
                    EasyPhotos.createAlbum(OfficeSuppliesOutApplyDetailActivity.this, true, GlideEngine.getInstance())
    ...
    private void updateStockInApply(String applyStatus) {
        ...
        String url = Constant.APP_BASE_URL + "stockApply/" + mStockOutApplyId;
        ...
        mVolleyUtil.httpPutRequest(url, paramMap, response -> {
            ...
            hideLoadingDialog();
            mVolleyUtil.handleCommonErrorResponse(OfficeSuppliesOutApplyDetailActivity.this, volleyError);
        });
    }
