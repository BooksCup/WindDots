...
import com.wd.winddots.desktop.list.check.activity.CheckActivity;
...
public class FabricQcActivity extends FragmentActivity implements View.OnScrollChangeListener, SwipeRefreshLayout.OnRefreshListener, ListBottomBar.ListBottomBarActionListener, CheckGoodsListAdapter.OnSubItemClickListener, CheckFilter.CheckFilterOnCommitClickListener {
