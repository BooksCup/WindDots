...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void setEmptyView(View emptyView) {
        ...
        if (mEmptyLayout == null) {
            ...
            final RecyclerView.LayoutParams layoutParams = new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.MATCH_PARENT);
    ...
    private void autoLoadMore(int position) throws InterruptedException {
        if (getLoadMoreViewCount() == 0) {
            return;
        }
    ...
    public interface RequestLoadMoreListener {
        ...
        void onLoadMoreRequested() throws InterruptedException;
